...
These are useful for reporting confidence intervals. Note that the dataset weighting produces a "design effect" which inflates the margin of error. I know the design effect is 1.15 for this dataset, based on the summary output produced by the `rake_weight()` procedure.
