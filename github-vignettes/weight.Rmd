...
This also provides a convenient method to compare to the survey dataset to be weighted. Notice that the formats between this list and the previous match exactly (i.e., same variable names and factor levels); this is a requirement for rake weighting.
